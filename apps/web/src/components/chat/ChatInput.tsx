...
import { MessageType, RoomState, UserState } from "@/types";
  ...
  return (
    <div className="flex-shrink-0 p-2 md:p-4 border-t border-gray-800 bg-gray-900/80 backdrop-blur supports-backdrop-blur:bg-gray-900/80">
      <div className="relative flex flex-col space-y-2">
        {/* Message Type Indicator - Now in a container with proper centering */}
        <div className="absolute bottom-full left-0 right-0 flex justify-center mb-1">
          <div className="bg-gray-900 rounded-lg px-3 shadow-lg">
            <div
